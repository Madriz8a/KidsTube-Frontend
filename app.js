...
// Función para verificar el PIN antes de permitir la edición del perfil
document.querySelectorAll('.editProfileButton').forEach(button => {
    button.addEventListener('click', async (e) => {
        ...
        // Mostrar el modal de confirmación de PIN
        const pinModal = new bootstrap.Modal(document.getElementById('pinModal'));
        pinModal.show();
    });
});

// Manejar el envío del formulario de PIN
document.getElementById('pinForm')?.addEventListener('submit', async (e) => {
    ...
    // Verificar si el PIN ingresado coincide con el del usuario
...
document.getElementById('updateProfileForm')?.addEventListener('submit', async (e) => {
    ...
    if (currentPassword || newPassword || repeatNewPassword) {
        ...
        // Aquí se debe implementar la validación de la contraseña actual con el backend
        // Por ahora, agregaremos las nuevas contraseñas al objeto userData
        userData.password = newPassword;
        userData.repeat_password = repeatNewPassword;
        // Nota: Esta implementación es simplificada. En una app real, deberías verificar
        // la contraseña actual con el backend antes de permitir el cambio
    }
...
const loadDashboardUserInfo = async () => {
    ...
    if (userDisplayName) userDisplayName.textContent = user.name || 'Usuario';
